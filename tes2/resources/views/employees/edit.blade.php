      ...
      <form method="post" action="{{ route("employee.update", $employee->id) }}">
        ...
        <div class="card-body">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="_name" name="name" placeholder="Enter name" value="{{ old("name") ?? $employee->name }}">
          </div>
          <div class="form-group">
            <label for="_email">Email address</label>
            <input type="email" class="form-control" id="_email" name="email" placeholder="Enter email" value="{{ old("email") ?? $employee->email }}">
          </div>
          {{--          <div class="form-group">--}}
          {{--            <label>Company</label>--}}
...
@section("addJs")
  ...
  <script>
    ...
    companies.select2("trigger", "select", {
      data: {
